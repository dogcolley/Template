...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
            ...
            */?>
			<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02">휴일등록</a></li><?php } ?>
        </ul>
        <?php
	...
	<div style="background:#f9f9f9;padding:30px 20px;margin-bottom:30px;border-bottom:1px solid #d9d9d9">
		<table class="U_table01">
			<tbody>
				...
				<tr>
					<td>휴일 유형</td>
					<td>
						<?=$view['wr_2'] ? '당일 부분 휴일': '당일 전체 휴일'?>
					</td>
				</tr>
				<?if($view['wr_2']){
					$sql = "select * from ".$g5['write_prefix'].$board['bo_1']." where wr_id = '".$view['wr_2']."' ";
					$qry = sql_query($sql);
				...
				<tr>
					<td>선택 예약</td>
					<td>
						<?=$row['wr_subject'].($row['wr_6'] ? ', 시간: '.$row['wr_6'] : '당일 전체');?>	
					</td>
				</tr>
				<?}}?>
				<tr>
	...
	<section id="bo_v_atc" class="sound_only">
